...
def run_crispr_db_data():
    """
    Backbone for simulations, reconstruction of whole dataset, excluding big groups. Precise likelihood function is
    used.
    :return:
    """
    ...
    rec_parameter_dict = {'model': 'gtr', 'gain_rate': 1, 'loss_rate': 0.1,
                          'give_lh_fct': os.path.join('data', '0_lh',
    ...
    save_path = os.path.join(result_folder,
                             ...
                             '1_excluding_big_dataset_precise_lh_fct',
                             )
