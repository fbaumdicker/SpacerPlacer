...
TREE_GENERATION_PARAMETERS = {'old_gain_rate': 6,  # based on omer data (without boring data; old and new lh fct)!
                              'old_loss_rate': 3 / 8,
                              'old_alpha': 5,
...
def run_lrt_quality_test():
    ...
    experiment_name = '2_simulation_LRT_evaluation_nlh_w_estimated_trees_precise_rates'
