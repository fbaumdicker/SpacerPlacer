...
def run_lrt_quality_test():
    ...
    experiment_name = '2_simulation_LRT_evaluation_nlh_w_estimated_trees_3_type_thetarho'
    ...
    group_by = 'sim|sim. gain rate'

    ls_alpha = [1.5, 1.5, 1.5]
    # dataset_avg_array_length = 16  # 18  # last dataset had ~22.38, median ~15.625
    ls_gain_rate = [2, 6, 60]
    ls_loss_rate = [0.04, 0.4, 4]
    sim_parameter_dict = {
