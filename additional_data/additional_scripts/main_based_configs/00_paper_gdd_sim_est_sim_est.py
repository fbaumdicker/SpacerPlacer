...
def determine_orientation_threshold():
    ...
    experiment_name = '00_paper_gdd_sim_est_sim_est'
    ...
    import_folder = os.path.join('0_result_folder', '0_paper',
                                 '00_paper_simulation_optimal_estimation_mean_length',
                                 )
    sim_parameter_dict = {'deletion_model': 'block',
                          'event_sim': True,
                          'tree_seed': 500,  # previously 5
                          'sim_seed': 500,  # previously 5
                          'import_path': os.path.join(import_folder, '0_sim_rec_protocol.pkl'),
                          'trees_path': os.path.join(import_folder, '1_simulations', 'dict_nwk_trees.pkl'),
                          'repeat_runs': 1,
