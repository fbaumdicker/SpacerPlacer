...
def determine_orientation_threshold():
    ...
    experiment_name = '00_paper_gdd_median_real_para_based_sim_5rr_5'
    ...
    import_folder = os.path.join('0_result_folder', '0_paper',
                                 '00_paper_real_data_optimal_estimation',
                                 'gdd_sim_avg_length_15_25')
    sim_parameter_dict = {'deletion_model': 'block',
                          'event_sim': True,
                          'tree_seed': 5000000,  # previously 5
                          'sim_seed': 5000000,  # previously 5
                          'import_path': os.path.join(import_folder, 'median_df_groups_w_avg_length_15_25.pkl'),
                          'trees_path': os.path.join(import_folder, 'trees_w_avg_length_15_25.pickle'),
                          'repeat_runs': 5,
