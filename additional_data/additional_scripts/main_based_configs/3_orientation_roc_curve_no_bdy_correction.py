...
def determine_orientation_threshold():
    ...
    experiment_name = '3_orientation_roc_curve_no_bdy_correction'
    ...
    import_folder = os.path.join('0_result_folder', '0_paper',
                                 '1_excluding_big_dataset_n_lh_fct_cg_trees_rho+alpha_bias_correction')
